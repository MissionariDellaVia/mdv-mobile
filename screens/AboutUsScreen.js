...
function SectionPills({active, onSelect}) {
  return (
...
export default function AboutUsScreen() {
  ...
  return (
    <ScrollView ref={scrollRef} style={styles.screen} contentContainerStyle={styles.content}>
      ...
      <SectionPills active={activeSection} onSelect={onSelectSection} />

      {activeSection === 'storia' && <StoriaSection />}
      {activeSection === 'contatti' && <ContattiSection />}
      {activeSection === 'siti' && <SitiSection />}
