...
import {BASE_URL, GOSPEL_WAY_INTRODUCTION} from '../services/Endpoints';

import {WebView} from 'react-native-webview';

const VangeloIntroductionScreen = ({navigation}) => {
  const {containerVangelo, webViewContainer} = styles;
  ...
  useEffect(() => {
    (async () => {
      const endpoint = BASE_URL + GOSPEL_WAY_INTRODUCTION;
...
export default VangeloIntroductionScreen;
